export const vi = {
  ...
  common: {
    ...
    admin: {
      ...
      faq: {
        title: "Quản lý FAQ",
        description: "Quản lý câu hỏi thường gặp hiển thị trên trang chủ",
        addNew: "Thêm FAQ mới",
        question: "Câu hỏi",
        answer: "Câu trả lời",
        questionVi: "Câu hỏi (Tiếng Việt)",
        answerVi: "Câu trả lời (Tiếng Việt)",
        questionEn: "Câu hỏi (Tiếng Anh)",
        answerEn: "Câu trả lời (Tiếng Anh)",
        order: "Thứ tự",
        isActive: "Hiển thị",
        edit: "Chỉnh sửa",
        delete: "Xóa",
        save: "Lưu FAQ",
        cancel: "Hủy",
        deleteConfirm: "Bạn có chắc chắn muốn xóa FAQ này?",
        createSuccess: "Tạo FAQ thành công",
        updateSuccess: "Cập nhật FAQ thành công",
        deleteSuccess: "Xóa FAQ thành công",
        noFaq: "Chưa có câu hỏi nào",
        editFaq: "Chỉnh sửa FAQ",
        createFaq: "Tạo FAQ mới"
      },
      common: {
        actions: "Thao tác",
        openMenu: "Mở menu",
