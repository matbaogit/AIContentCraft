...
class DatabaseStorage implements IStorage {
  ...
  async getAnalyticsOverview(startDate: Date, endDate: Date): Promise<{
    ...
    try {
      ...
      // SEO content created (articles - assuming all articles are SEO content)
      ...
      // Images generated by AI (using all images for now)
      ...
      // Social content created (using scheduled_posts for social platforms)
